        ...
        if (
            !(
                ...
                ((i = navigator.connection) &&
                    ((i.effectiveType || "").includes("2g") || i.saveData))
            )
        )
            return (
                r
        ...
        f =
            ...
            new IntersectionObserver(function (e) {
                e.forEach(function (e) {
                    if (e.isIntersecting) {
                        var n = e.target;
                        c.has(n.href) && (f.unobserve(n), a(n.href));
                    }
                });
            });
    function a(e) {
        c.delete(e), i(new URL(e, location.href).toString(), f.priority);
    }
    return function (e) {
        e || (e = {}), f && (f.priority = e.priority || !1);
