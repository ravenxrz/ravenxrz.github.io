...
![](https://ravenxrz-blog.oss-cn-chengdu.aliyuncs.com/img/github_img/image-20200619232328439.png)

现在的关键是如何得到这个 **剩余3bit信息：**

如果可以将当扫描位后的所有位置为1，我们就可以**将问题转化为统计 当前数字的二进制表示 有多少个1了。**（为什么要这么想，因为有**bitcount算法**啊）

![](https://ravenxrz-blog.oss-cn-chengdu.aliyuncs.com/img/github_img/image-20200619232535359.png)
