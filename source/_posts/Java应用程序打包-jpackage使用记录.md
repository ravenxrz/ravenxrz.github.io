...
![](https://ravenxrz-blog.oss-cn-chengdu.aliyuncs.com/img/github_img/image-20200506083414289.png)
...
![](https://ravenxrz-blog.oss-cn-chengdu.aliyuncs.com/img/github_img/image-20200506085408605.png)
...
![](https://pic.downk.cc/item/5eb22654c2a9a83be5ae6281.png)

测试一下通过java -jar能否运行：

![](https://ravenxrz-blog.oss-cn-chengdu.aliyuncs.com/img/github_img/image-20200506090006946.png)

好的，现在我们将这个jar包打成安装包：

在根目录下建立一个lib，并把Non-modular-packging-demo.jar复制进lib目录下：

![](https://ravenxrz-blog.oss-cn-chengdu.aliyuncs.com/img/github_img/image-20200506090210470.png)
...
![](https://ravenxrz-blog.oss-cn-chengdu.aliyuncs.com/img/github_img/image-20200506091042775.png)
...
![](https://ravenxrz-blog.oss-cn-chengdu.aliyuncs.com/img/github_img/image-20200506091723697.png)

![](https://ravenxrz-blog.oss-cn-chengdu.aliyuncs.com/img/github_img/image-20200506091759019.png)

![](https://ravenxrz-blog.oss-cn-chengdu.aliyuncs.com/img/github_img/image-20200506091808728.png)

现在双击启动程序试试，应该就有beep了。再看看安装目录：

![](https://ravenxrz-blog.oss-cn-chengdu.aliyuncs.com/img/github_img/image-20200506092615980.png)
...
![](https://ravenxrz-blog.oss-cn-chengdu.aliyuncs.com/img/github_img/image-20200506092833058.png)
...
![](https://ravenxrz-blog.oss-cn-chengdu.aliyuncs.com/img/github_img/image-20200506093330774.png)

## 3. 模块程序打包

通过maven新建JavaFX项目，得到如下目录：

![](https://ravenxrz-blog.oss-cn-chengdu.aliyuncs.com/img/github_img/image-20200506085023406.png)

运行一下，看下效果：

![](https://ravenxrz-blog.oss-cn-chengdu.aliyuncs.com/img/github_img/image-20200506093953328.png)



模块化程序打包就略微复杂一些了，首先明确一点，idea中，有maven在，所有的编译输出不在out目录下，而在target目录下：

![](https://ravenxrz-blog.oss-cn-chengdu.aliyuncs.com/img/github_img/image-20200506094133814.png)

除此之外，还需要明确我们当前的模块名：

![](https://ravenxrz-blog.oss-cn-chengdu.aliyuncs.com/img/github_img/image-20200506094239319.png)
...
![](https://ravenxrz-blog.oss-cn-chengdu.aliyuncs.com/img/github_img/image-20200506095324701.png)

生成如下的依赖图：

![](https://ravenxrz-blog.oss-cn-chengdu.aliyuncs.com/img/github_img/image-20200506095350078.png)
...
![](https://ravenxrz-blog.oss-cn-chengdu.aliyuncs.com/img/github_img/image-20200506095511115.png)

在这上面右键-->Show in Exploer即可。

![](https://ravenxrz-blog.oss-cn-chengdu.aliyuncs.com/img/github_img/image-20200506095601116.png)
...
![](https://ravenxrz-blog.oss-cn-chengdu.aliyuncs.com/img/github_img/image-20200506100019571.png)
...
![](https://ravenxrz-blog.oss-cn-chengdu.aliyuncs.com/img/github_img/image-20200506100337247.png)

![](https://ravenxrz-blog.oss-cn-chengdu.aliyuncs.com/img/github_img/image-20200506100405088.png)
...
![](https://ravenxrz-blog.oss-cn-chengdu.aliyuncs.com/img/github_img/image-20200506102259548.png)

会得到：

![](https://ravenxrz-blog.oss-cn-chengdu.aliyuncs.com/img/github_img/image-20200506102410359.png)
...
![](https://ravenxrz-blog.oss-cn-chengdu.aliyuncs.com/img/github_img/image-20200506102742159.png)
...
![](https://ravenxrz-blog.oss-cn-chengdu.aliyuncs.com/img/github_img/image-20200506103403094.png)
