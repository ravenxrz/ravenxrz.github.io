...
我的做法是，将整个 `mit6824` 目录移动到 `$GOPATH/src`目录下，并去掉了 `mit6824/src`目录，最终的文件组织结构如下：
...
![](https://ravenxrz-blog.oss-cn-chengdu.aliyuncs.com/img/github_img/image-20220213190550211.png)
